    ...
    <div className='container'>
      ...
      <div className="row justify-content-around">
        <div className="col-lg-5">
          <img src={imagen1} className='img-thumbnail' alt="Imagen de la noticia" />
          <h2>Título de la Noticia</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque molestie enim sed tincidunt ornare. Proin vehicula turpis a odio euismod, id venenatis augue molestie<a href="#"> ... Leer más</a>
          </p>
        </div>
        <div className="col-lg-5">
          <img src={imagen1} className='img-thumbnail' alt="Imagen de la noticia" />

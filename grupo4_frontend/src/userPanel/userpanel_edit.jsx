...
export class InternalUsersEdit extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.params.user_id) {
            ...
            fetch(`http://localhost:8080/users/${this.props.params.user_id}`, parametros)
                .then(res => {
                    return res.json()
                        .then(body => {
                            return {
    ...
    handleSubmit = (event) => {
        ...
        const url = this.props.params.user_id ? `http://localhost:8080/users/${this.props.params.user_id}` : "http://localhost:8080/users"
    ...
    render() {
        return (
            <div className='col-10'>
                <div className='row'>
                    <div className='col'>
                        <h1>{this.props.params.user_id ? `Edicion del Usuario ${this.props.params.user_id}` : "Alta de Usuario"}</h1>
                    </div>
                </div>
